  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <hr className="h-line mb-3" />
        <div className="container">
          <p className="text-center orangeText display-5">
          ...
          <div className="row">
            ...
            <div>
              ...
              <p>
                ...
                volume that can then be manipulated more easily (often referred
                to as volume rendering).
              </p>
            </div>
